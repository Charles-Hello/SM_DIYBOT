...
async def new():
    info = '[项目地址](https://github.com/Charles-Hello/ql_diybot/) \t| \t[交流频道](https://t.me/yangqun80) '
    if os.path.exists(_botuplog):
        ...
        if not isnew:
            ...
            await jdbot.send_message(chat_id, f'[机器人上新了](https://github.com/Charles-Hello/ql_diybot/jddockerbot/tree/master)\n{botlog}\n运行日志为log/bot/run.log\n\n\t{info}', link_preview=False)
    else:
